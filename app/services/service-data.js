...
export const SERVICE_PAGES = [
  ...
  },
  {
    ...
    plans: [
      ["普通套餐", "¥108/年", "600 GB，专线多节点日常浏览与流媒体"],
      ["高级套餐", "¥188/年", "1200 GB，专线更高带宽与更多节点"],
      ["豪华套餐", "¥328/年", "2400 GB，套餐期限内可定制1个原生isp节点"],
      ["无限套餐", "¥588/年", "无限流量，重度用户首选，可定制2个原生isp节点"],
      ["5元10GB测试", "¥5/次", "5 元 10GB 体验，先测试再决定"],
    ],
    faq: [
...
const SERVICE_EN = {
  ...
  "airport-node": {
    ...
    plans: [
      ["Standard", "¥108/yr", "600 GB, multi-node lines for browsing and streaming"],
      ["Plus", "¥188/yr", "1200 GB, more bandwidth and more nodes"],
      ["Premium", "¥328/yr", "2400 GB, one custom native ISP node for the term"],
      ["Unlimited", "¥588/yr", "Unlimited traffic for heavy use, two custom native ISP nodes"],
      ["¥5 / 10 GB trial", "¥5/once", "¥5 for 10 GB — try before you commit"],
    ],
    faq: [
...
export const SERVICE_PLAN_COPY_EN = {
  ...
  "airport-node": {
    basic: { name: "Standard", description: "600 GB, multi-node lines for browsing and streaming" },
    pro: { name: "Plus", description: "1200 GB, more bandwidth and more nodes" },
    luxury: { name: "Premium", description: "2400 GB, one custom native ISP node for the term" },
    unlimited: { name: "Unlimited", description: "Unlimited traffic for heavy use, two custom native ISP nodes" },
    trial: { name: "¥5 / 10 GB trial", description: "¥5 for 10 GB — try before you commit" },
  },
  "proxy-payment": {
