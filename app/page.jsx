...
const SITE_CONTENT = {
  ...
  faq: [
    {
      q: "下单后多久能用？",
      a: "支付完成后工作人员将在 10 分钟内处理（高峰期不超过 1 小时），通常 5 分钟即可使用，所有开通均由真人客服核对，确保稳定准确",
    },
    {
      q: "账号安全有保障吗？会被封禁吗？",
...
const LIVE_ORDERS = [
  ...
  { city: "长沙",       name: "何**",      product: "机场节点 · 普通套餐",        time: "1 小时前" },
  { city: "高雄",       name: "Olivia*",   product: "Spotify + Netflix",          time: "1 小时前" },
  { city: "成都",       name: "Leo**",     product: "机场节点 · 豪华套餐",        time: "2 小时前" },
...
const PRODUCT_PROMOS = {
  ...
  rocket:   { badge: "必备工具", badgeIcon: Sparkles, originalPrice: 268, monthly: "≈¥10.7/月", soldThisMonth: 1580 },
};
