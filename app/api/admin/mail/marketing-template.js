...
function defaultProducts(origin) {
  return [
    { name: "Spotify", subtitle: "欧美日高价区多规格订阅", price: "¥128/年起", href: origin + "/services/spotify", icon: "spotify.jpg" },
    { name: "4K 影音会员", subtitle: "Netflix · Disney+ · HBO Max", price: "¥108/年起", href: origin + "/shop", icon: "streaming-4k-edm-v2.jpg" },
    { name: "AI 会员", subtitle: "ChatGPT · Claude 官方会员", price: "¥198/三个月起", href: origin + "/services/ai", icon: "ai.jpg" },
    { name: "机场节点", subtitle: "稳定高速科学上网节点", price: "¥128/年起", href: origin + "/services/airport-node", icon: "rocket.jpg" },
  ];
}
