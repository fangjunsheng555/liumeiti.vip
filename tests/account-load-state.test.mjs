...
for (const [name, payload] of [
  ...
  ["unsafe finite balance", { ok: true, balance: Number.MAX_SAFE_INTEGER + 1, transactions: [], withdrawals: [], coupons: [] }],
  ["negative balance", { ok: true, balance: -0.01, transactions: [], withdrawals: [], coupons: [] }],
  ["three-decimal balance", { ok: true, balance: 12.345, transactions: [], withdrawals: [], coupons: [] }],
  ["sub-cent balance", { ok: true, balance: 0.001, transactions: [], withdrawals: [], coupons: [] }],
